...
const SearchPage = () => {
    ...
    return (
        <div className="relative overflow-x-hidden bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 min-h-screen">
            <div className="relative flex flex-col items-center justify-center p-10">
                ...
                <div className="flex justify-center flex-col items-center mx-auto w-full">
                    <input
                        ...
                        className="w-full border-2 max-w-[700px] h-10 px-6 rounded-full focus:outline-none mb-10 md:mb-18 min-w-[300px] focus:shadow-lg transition duration-300 ease-in-out bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                    ...
                    <div className="flex justify-center items-center gap-4 p-1 w-full flex-wrap">
                        {filteredResults.map((result) => (
                            <div
                                key={result._id}
                                className="border-2 border-gray-300 dark:border-gray-600 min-w-72 text-center px-4 md:px-6 py-2 md:py-1 rounded-2xl cursor-pointer hover:scale-105 transition-all ease-in-out duration-300 w-fit bg-gray-200 dark:bg-gray-800 text-gray-900 dark:text-gray-100"
