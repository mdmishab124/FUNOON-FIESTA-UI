        ...
        <div className="cart-container p-6 bg-gray-100 dark:bg-gray-900 min-h-screen">
            ...
            <div className="search-bar mb-6 flex justify-center">
                <input
                    ...
                    className="w-full sm:w-1/2 p-3 border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-600"
                />
            </div>
